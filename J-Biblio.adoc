...
* Sudoc utilise un format RDF national, géré par les bibliothécaires. Viellles notices sont de moindre qualité mais les plus récentes devraient être bonnes. https://www.sudoc.fr/146956419.rdf[Exemple]. Pas ou très peu d’articles (pas sa vocation première).
* Copac équivalent du Sudoc en GB, utilise format http://www.loc.gov/standards/mods/[MODS].
* https://data.bnf.fr[BNF] : dépôt légal, acquisitions.
...
* http://m.abes.fr/Espace-Pro-Acces-direct-a/Utiliser-les-web-services[Web services] de l’ABES (Idref…).
