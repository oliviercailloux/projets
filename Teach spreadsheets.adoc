...
On repartira d’un https://github.com/oliviercailloux/Teach-spreadsheets[projet] existant.

== Commencer par
* Mettre à jour dépendances, vérifier config JUnit 5 et Guava en particulier, enlever du POM tout ce qui ne semble pas utile
...
* Améliorer lisibilité du code, utiliser des objets immuables là où c’est censé (procéder par sujet)
