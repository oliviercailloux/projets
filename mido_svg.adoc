...
* Bibliothèque générale permettant de générer des SVG (sans interface graphique).
* Bibliothèque particulière permettant de générer des SVG MIDO (sans interface graphique).
