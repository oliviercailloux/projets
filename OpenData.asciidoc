...
* Import d’autres données que l’annuaire, telles que fichiers du Référentiel de l’Offre de Formation (ROF) au format CDM-fr (voir link:OF_MEA5STI.xml) ; Menu du Crous ; prochaines conférences à Dauphine.
